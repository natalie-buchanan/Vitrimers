...
"""
By Jason Mulderrig
https://github.com/jasonmulderrig/heterogeneous-spatial-networks/blob/main/heterogeneous_spatial_networks_funcs.py
"""
...
def filepath_str(network: str) -> str:
    ...
    # For Windows OS
    #filepath = f"C:\\Users\\Natalie.Buchanan\\OneDrive - BlueHalo LLC\\Documents\\GitHub\\Vitrimers\\Data\\"
    filepath = os.path.join(os.getcwd(), "Data", network)
