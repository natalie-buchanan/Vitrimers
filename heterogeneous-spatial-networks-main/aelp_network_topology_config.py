...
def main():
    ...
    network_auelp_batch_A_filename_prefix = os.path.join(
        network_auelp_filepath, f"{date}{batch_A}"
    )
    network_auelp_batch_B_filename_prefix = os.path.join(
        network_auelp_filepath, f"{date}{batch_B}"
    )
    network_apelp_batch_A_filename_prefix = os.path.join(
        network_apelp_filepath, f"{date}{batch_A}"
    )
    network_apelp_batch_B_filename_prefix = os.path.join(
    ...
    config_arr = np.arange(2, dtype=int) # 0, 1, 2, ..., 198, 199
